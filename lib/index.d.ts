import { OneOf, Type, Validator } from './types/types.d';
export declare function oneOf(...types: [Type, Validator[]][]): OneOf;
...
export declare function tuple(length: number, ...types: [Type, Validator[]][]): Type;
